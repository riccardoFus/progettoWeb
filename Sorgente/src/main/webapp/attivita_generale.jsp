<jsp:include page="header.jsp"/>
    ...
    <div class="column" id = "col1">
        ...
        <h3>idroterapia</h3>
        <div class="row">
            <a href="<%= response.encodeURL("./idroterapia.jsp")%>"><img src="images/aquagym.jpg" alt="aquagym" ></a>
            <p>
    ...
    <div class="column" id = "col2">
        ...
        <div class="row">
            ...
            <a href="<%= response.encodeURL("./giochi.jsp")%>"><img src="images/giochi_da_tavolo.jpg" alt="giochi da tavolo" ></a>
        </div>
    </div>
    ...
    <div class="column" id = "col3">
        ...
        <div  class="row">
            <a href="<%= response.encodeURL("./supporto_studenti.jsp")%>"><img src="images/psicologia.jpg" alt="supporto psicologico" ></a>
            <p>
